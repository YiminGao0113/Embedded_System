...
// outputs: none
// Same with BSP_LCD_DrawAircraft
void BSP_LCD_DrawCrosshair(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastVLine(x-4, y-1, 4, LCD_YELLOW);
    BSP_LCD_DrawFastVLine(x+4, y-1, 4, LCD_YELLOW);  
		BSP_LCD_DrawFastHLine(x-6, y, 13, color);
    BSP_LCD_DrawFastHLine(x-6, y+1, 13, color);
    BSP_LCD_DrawFastVLine(x, y-4, 8, LCD_RED);
    BSP_LCD_DrawFastVLine(x+1, y-2, 7, LCD_WHITE);
    BSP_LCD_DrawFastVLine(x-1, y-2, 7, LCD_WHITE);
    BSP_LCD_DrawFastHLine(x-2, y, 5, color);
    BSP_LCD_DrawFastHLine(x-3, y+4, 7, LCD_RED);
}
void BSP_LCD_DrawCrosshair_Black(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastHLine(x-6, y, 13, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x-6, y+1, 13, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x, y-4, 2, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x, y-2, 9, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x+1, y-3, 8, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x-1, y-3, 8, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x-2, y, 5, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x-4, y-1, 4, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x+4, y-1, 4, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x-3, y+4, 7, LCD_BLACK);
}
//------------BSP_LCD_DrawCube-------------------
//Same with BSP_LCD_DrawEnemy
void BSP_LCD_DrawCube(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastVLine(x*10+4, y*10, 10, color);
    BSP_LCD_DrawFastVLine(x*10+5, y*10, 10, color);
	  BSP_LCD_DrawFastHLine(x*10+2, y*10+1, 6, LCD_GREY);
		BSP_LCD_DrawFastHLine(x*10, y*10+4, 10, LCD_GREY);
    BSP_LCD_DrawFastHLine(x*10, y*10+5, 10, LCD_GREY);
    BSP_LCD_DrawFastHLine(x*10+1, y*10+6, 8, LCD_GREY);
}

void BSP_LCD_DrawCube_Black(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastHLine(x*10+2, y*10+1, 6, LCD_BLACK);
		BSP_LCD_DrawFastHLine(x*10, y*10+4, 10, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x*10, y*10+5, 10, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x*10+1, y*10+6, 8, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x*10+4, y*10, 10, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x*10+5, y*10, 10, LCD_BLACK);
}
//------------BSP_LCD_DrawAircraft-------------------
void BSP_LCD_DrawAircraft(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastVLine(x-4, y-1, 4, LCD_YELLOW);
    BSP_LCD_DrawFastVLine(x+4, y-1, 4, LCD_YELLOW);  
    BSP_LCD_DrawFastHLine(x-6, y, 13, color);
    BSP_LCD_DrawFastHLine(x-6, y+1, 13, color);
...
void BSP_LCD_DrawAircraft_Black(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastHLine(x-6, y, 13, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x-6, y+1, 13, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x, y-4, 2, LCD_BLACK);
    BSP_LCD_DrawFastVLine(x, y-2, 9, LCD_BLACK);
...
void BSP_LCD_DrawEnemy_Black(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastHLine(x*10+2, y*10+1, 6, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x*10, y*10+4, 10, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x*10, y*10+5, 10, LCD_BLACK);
    BSP_LCD_DrawFastHLine(x*10+1, y*10+6, 8, LCD_BLACK);
...
//------------BSP_LCD_DrawBullet-------------------
void BSP_LCD_DrawBullet(int16_t x, int16_t y, int16_t color) {
    BSP_LCD_DrawFastVLine(x, 0, y, color);
}
//------------BSP_LCD_DrawStart-------------------
void BSP_LCD_DrawStart(void) {
    //Aircraft
    BSP_LCD_DrawFastVLine(64, 96, 16, LCD_RED);
    BSP_LCD_DrawFastVLine(63, 96, 16, LCD_RED);
    BSP_LCD_DrawFastVLine(65, 96, 16, LCD_RED);
    BSP_LCD_DrawFastVLine(62, 100, 14, LCD_WHITE);
    BSP_LCD_DrawFastVLine(66, 100, 14, LCD_WHITE);
    BSP_LCD_DrawFastVLine(61, 100, 14, LCD_WHITE);
    BSP_LCD_DrawFastVLine(67, 100, 14, LCD_WHITE);
    BSP_LCD_DrawFastVLine(56, 101, 8, LCD_YELLOW);
    BSP_LCD_DrawFastVLine(57, 101, 8, LCD_YELLOW);
    BSP_LCD_DrawFastVLine(71, 101, 8, LCD_YELLOW);
    BSP_LCD_DrawFastVLine(72, 101, 8, LCD_YELLOW);
    BSP_LCD_DrawFastHLine(57, 115, 13, LCD_RED);
    BSP_LCD_DrawFastHLine(57, 116, 13, LCD_RED);
    BSP_LCD_DrawFastHLine(52, 105, 25, LCD_RED);
    BSP_LCD_DrawFastHLine(52, 104, 25, LCD_RED);
    BSP_LCD_DrawFastHLine(52, 106, 25, LCD_RED);
    BSP_LCD_DrawFastHLine(52, 107, 25, LCD_RED);
    //H-35
    //H
    BSP_LCD_DrawFastVLine(20, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(21, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(22, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(23, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(24, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(30, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(31, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(32, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(33, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(34, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastHLine(20, 20, 4, LCD_WHITE);
    BSP_LCD_DrawFastHLine(20, 40, 4, LCD_WHITE);
    BSP_LCD_DrawFastHLine(30, 20, 4, LCD_WHITE);
    BSP_LCD_DrawFastHLine(30, 40, 4, LCD_WHITE);
    BSP_LCD_DrawFastHLine(24, 28, 6, LCD_WHITE);
    BSP_LCD_DrawFastHLine(24, 29, 6, LCD_WHITE);
    BSP_LCD_DrawFastHLine(24, 30, 6, LCD_WHITE);
    BSP_LCD_DrawFastHLine(24, 31, 6, LCD_WHITE);
    //-
    BSP_LCD_DrawFastHLine(40, 28, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(40, 29, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(40, 30, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(40, 31, 14, LCD_WHITE);
    //3
    BSP_LCD_DrawFastHLine(60, 28, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 29, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 30, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 31, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 20, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 21, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 22, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 23, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 37, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 38, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 39, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(60, 40, 14, LCD_WHITE);
    BSP_LCD_DrawFastVLine(71, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(72, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(73, 20, 20, LCD_WHITE);
    BSP_LCD_DrawFastVLine(74, 20, 20, LCD_WHITE);
    //5
    BSP_LCD_DrawFastHLine(80, 28, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 29, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 30, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 31, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 20, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 21, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 22, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 23, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 37, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 38, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 39, 14, LCD_WHITE);
    BSP_LCD_DrawFastHLine(80, 40, 14, LCD_WHITE);
    BSP_LCD_DrawFastVLine(91, 30, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(92, 30, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(93, 30, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(94, 30, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(80, 20, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(81, 20, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(82, 20, 10, LCD_WHITE);
    BSP_LCD_DrawFastVLine(83, 20, 10, LCD_WHITE);
    //1
    BSP_LCD_DrawFastVLine(103, 20, 20, LCD_RED);
    BSP_LCD_DrawFastVLine(104, 20, 20, LCD_RED);
    BSP_LCD_DrawFastVLine(105, 20, 20, LCD_RED);
    BSP_LCD_DrawFastVLine(106, 20, 20, LCD_RED);
}
