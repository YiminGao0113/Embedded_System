...
void BSP_LCD_DrawCrosshair_Black(int16_t x, int16_t y, int16_t bgColor);
//Same with BSP_LCD_DrawEnemy
void BSP_LCD_DrawCube(int16_t x, int16_t y, int16_t bgColor);

void BSP_LCD_DrawCube_Black(int16_t x, int16_t y, int16_t bgColor);

void BSP_LCD_DrawAircraft(int16_t x, int16_t y, int16_t bgColor);

void BSP_LCD_DrawEnemy(int16_t x, int16_t y, int16_t bgColor);

void BSP_LCD_DrawBullet(int16_t x, int16_t y, int16_t bgColor);
